...
1. `flutter create teacher_web --platforms web` in repo root, or use Vite/React per team preference.
2. Consume the same summary JSON shape as the mobile `ExportSummaryService`.
3. Deploy static assets per README “Deploy demo”.
